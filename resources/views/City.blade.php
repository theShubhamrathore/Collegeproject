               ...
               <div class="col-md-6 col-sm-6">
                    <div class="home-thumb">
                         <div class="section-title">
                              ...
                              <h1 class="wow fadeInUp" data-wow-delay="0.6s">Kota🏙️</h1>
                              ...
                              <a href="#quotes1" class="wow fadeInUp smoothScroll section-btn btn btn-success" data-wow-delay="1.4s">About Kota</a>
...
<section id="quotes1" class="parallax-section">
     ...
     <div class="container">
          <div class="row">
               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    ...
                    <h2 class="wow fadeInUp" data-wow-delay="0.8s" style="color: black;">Kota</h2>
                    <h4 class="wow fadeInUp" data-wow-delay="1s" style="color: black;">Education City of Rajasthan.</h4>
                    <p>Kota is the Smart City that Locate in the rajasthan.Kota is popular for education.</p>
               </div>
