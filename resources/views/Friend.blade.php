...
<title>Shubham rathore friend list</title>
...
<div class="navbar navbar-fixed-top custom-navbar" role="navigation">
     <div class="container">
          ...
          <div class="navbar-header">
               ...
               <a href="http://127.0.0.1:8000/" class="navbar-brand">Shubham</a>
          </div>
...
<h3 class="heading">.<br> About My friends🙌</h3>
<h4>List of my premium friends..</h4>

<div class="friendinfo" >
     <div class="tanmay" style="display: flex;">
     <h3>Tanmay Maheshwari❤️ &nbsp;&nbsp; &nbsp;</h3>
     <h3><span class="fa fa-star checked" style="color: orange;"></span>
<span class="fa fa-star checked" style="color: orange;"></span>
<span class="fa fa-star checked" style="color: orange;"></span>
<span class="fa fa-star checked" style="color: orange;"></span>
<span class="fa fa-star checked" style="color:orange"></span></h3>
     </div>
...
<!-- <div class="gallery">
     ...
     <div class="gallery-item">
          <img class="gallery-image" src="https://drive.google.com/file/d/1GZEqPB0d_B5KSnJWSTrQ8to6p6WI190h/view?usp=share_link" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">
     </div>
     ...
     <div class="gallery-item">
          <img class="gallery-image" src="https://images.unsplash.com/photo-151404118" alt="car interior from central back seat position showing driver and blurred view through windscreen of a busy road at night">
     </div>
...
<section>
     <div class="addfriend">
     <h4 ><strong>Add yourself as my Premium friend</strong>
     <a href="#" style="color: blue;">Add friend</a>
     </h4>
     </div>
     ...
     <!-- <div class="list">
          ...
          <table border="1">
               ...
               <tr>
                    <td style="color: #1a1a1a;">{{$user['name']}}</td>
                    <td>{{$user['email']}}</td>
     ...
     <h5 class="heading"> -: Friend list :-</span></h2>
     <div class="list" >
          <table>
     @foreach($users as $user)
               
                    <!-- <h4 style="color: #1a1a1a;">{{$user['name']}} &nbsp; &nbsp;&nbsp; &nbsp; {{$user['email']}} <br></h4> -->
                    
                    <!-- <h4 style="color: #1a1a1a;">{{$user['email']}}</h4> -->
                    <!-- <ol>
